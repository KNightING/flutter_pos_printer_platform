...
import 'package:image/image.dart' as imageApi;
...
class TsplPrinter<T> extends GenericPrinter<T> {
  ...
  Future<bool> image(Uint8List image, {int threshold = 150}) async {
    final decodedImage = imageApi.decodeImage(image)!;
